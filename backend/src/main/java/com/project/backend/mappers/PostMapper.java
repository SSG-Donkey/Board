...
public interface PostMapper {
    ...
    int insertPost(String post_title,String post_content,String post_file,Integer user_no,Integer post_views,Integer post_category,Integer region_no,Integer post_status);
}
